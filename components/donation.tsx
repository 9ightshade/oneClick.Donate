        ...
        <div className="max-w-lg mx-auto px-4 sm:px-6 text-center py-16">
          <div className="bg-white rounded-2xl shadow-2xl p-8 animate-fade-in">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Your contribution of ${parseFloat(customAmount).toFixed(2)} will
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 max-w-xl mx-auto lg:mx-0">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="#donation-form"
                className="px-6 py-3 border border-gray-300 rounded-lg text-base font-semibold text-gray-700 hover:bg-gray-50 transition-colors duration-300">
          ...
          <div
            ...
            <p className="mb-4 text-gray-600">
              ...
              {donationType === "monthly" &&
                "Support us monthly for sustained impact"}
              {donationType === "annual" &&
                "Make a yearly commitment with greater impact"}
            </p>
            ...
            <div className="mb-8">
              <p className="text-sm text-gray-500 mb-2">
                {donationType === "one-time" &&
                  "Your one-time donation helps fund immediate needs"}
                {donationType === "monthly" &&
                  "Monthly donations help us plan for the future"}
                {donationType === "annual" &&
                  "Annual donations provide substantial support with less processing"}
              </p>
              {donationType !== "one-time" && (
